            ...
            <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
              ...
              <div className="text-center md:text-left">
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                  <h1 className="text-4xl md:text-5xl font-black text-[#2d2d2d] tracking-tighter">
                    Luke H. Jung
                  </h1>
                  <a 
                    href="/files/Luke-Jung-Resume.pdf" 
                    download 
                    className="inline-flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-[#5d4037] hover:bg-[#5d4037]/5 px-4 py-2 rounded-full border border-[#5d4037]/20 transition-all"
                  >
                    Download PDF Resume <i className="fa fa-download"></i>
                  </a>
                </div>
